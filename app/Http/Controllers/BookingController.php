...
class BookingController extends Controller
{
    ...
    public function premiumPicturePurchaseCheck(Request $req)
    {
        ...
        if(!$validator->fails()){
            ...
            $comments = PremiumPictureComment::where('picture_id',$req->pictureId)->with('userDetails')->get();

            $specific_user_comment = premiumPictureComment(Auth::user()->id,$req->pictureId)->count();
            if($picture){
                ...
                $data['specific_user_comment'] = $specific_user_comment;
