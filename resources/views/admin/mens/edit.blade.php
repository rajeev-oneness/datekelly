            ...
            <form class="form" method="POST" action="{{route('admin.mens.update')}}" enctype="multipart/form-data">
                ...
                <div class="form-group row align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="text" class="form-control" name="phn_no" placeholder="Enter Phone no" value="{{$men->phn_no}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="10" />
