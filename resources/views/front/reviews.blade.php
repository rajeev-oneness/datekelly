                        ...
                        <div class="card-header border-0 pt-1 d-flex">
                            <p>
                                <span class="text-lblue">{{$item->user_details->name}}</span> review of <span class="textpink">
                                    <a href="{{route('advertisement.detail',[base64_encode($item->advertisement_id)])}}">{{$item->advertisement_details_for_review ? $item->advertisement_details_for_review->title : ''}}</a>
                                </span>
                                <br>{{ $item->advertisement_details_for_review ? date('M Y', strtotime($item->advertisement_details_for_review->created_at)) : '' }}
                            </p>
