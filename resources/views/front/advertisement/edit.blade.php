									...
									<div class="row">
										<div class="col md-6">
											<div class="row">
												From : 
												@php
													if(count($markedSelectedDays) > 0){
														$after_explode_from_time = explode(':',$markedSelectedDays['from']);
														$after_explode_till_time = explode(':',$markedSelectedDays['till']);
													}	
												@endphp
												<div class="col-md-5">
													<select name="workingTimeFromHour[]" id="" class="form-control">
														...
														@for ($i = 01; $i<= 24; $i++)
															<option value="{{ $i }}" @if (count($markedSelectedDays) > 0)
																@if ($after_explode_from_time[0] == $i)
																	selected
																@endif
															@endif>{{ $i }}</option>
														@endfor
												...
												<div class="col-md-5">
													<select name="workingTimeFromMinute[]" id="" class="form-control">
														...
														<option value="00" @if (count($markedSelectedDays) > 0)
															@if ($after_explode_from_time[1] == 00)
																selected
															@endif
														@endif>00</option>
														<option value="30" @if (count($markedSelectedDays) > 0)
															@if ($after_explode_from_time[1] == 30)
																selected
															@endif
														@endif>30</option>
													</select>
											...
											<div class="row">
												...
												<div class="col-md-5">
													<select name="workingTimeTillHour[]" id="" class="form-control">
														...
														@for ($i = 01; $i<= 24; $i++)
															<option value="{{ $i }}" @if (count($markedSelectedDays) > 0)
																@if ($after_explode_till_time[0] == $i)
																	selected
																@endif
															@endif>{{ $i }}</option>
														@endfor
												...
												<div class="col-md-5">
													...
													<select name="workingTimeTillMinute[]" id="" class="form-control">
														<option value="">Select Minute</option>
														<option value="00" @if (count($markedSelectedDays) > 0)
															@if ($after_explode_till_time[1] == 00)
																selected
															@endif
														@endif>00</option>
														<option value="30" @if (count($markedSelectedDays) > 0)
															@if ($after_explode_till_time[1] == 30)
																selected
															@endif
														@endif>30</option>
													</select>
