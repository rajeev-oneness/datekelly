 ...
 * Demo purpose
 */
Route::get('/demo', 'FrontController@demo')->name('demo.home');
...
//tip
Route::post('lady-tip', 'AdvertisementController@ladyTip')->name('lady.tip');
...
// Premium Picture Comment
Route::post('/premium-picture/comment', 'PremiumPictureCommentController@index')->name('premium.picture.comment.index');
Route::post('/premium-picture/comment/store', 'PremiumPictureCommentController@store')->name('premium.picture.comment.store');